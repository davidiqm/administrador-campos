...
export default function CamposLista(props) {
  const Item = ({ item }) => (
    <a onClick={() => props.getCampo(item.id)} className={"align-middle my-2 flex w-full px-6 py-3 bg-gray-100 border border-gray-400 rounded-lg shadow hover:bg-gray-200"}>
        ...
        <div className={"text-left"}>
            <div>
              ...
              <p className={"text-xs"} >Area: {item.area}ha</p>
            </div>
        </div>
        <div className={""}>
